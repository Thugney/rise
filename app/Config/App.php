...
class App extends BaseConfig {
     ...
     *    http://example.com/
     *
     * IMPORTANT: When deployed in /crm subdirectory, set this to include /crm
     * because the app is physically located in that folder.
     * Example: 'https://eriteach.com/crm/' (includes the subdirectory)
     *
     ...
     * @var string
     */
    public $baseURL = 'https://eriteach.com/crm/';
