...
//this route will move 'about/any-text' to 'domain.com/crm/about/any-text'
$routes->add('about/(:any)', 'About::index/$1');

// SEO routes - sitemap and robots
$routes->get('sitemap\.xml', 'Sitemap::index');
$routes->get('sitemap', 'Sitemap::index');
$routes->get('sitemap/html', 'Sitemap::html');

//add routing for controllers
$excluded_controllers = array("About", "App_Controller", "Security_Controller", "Sitemap");
