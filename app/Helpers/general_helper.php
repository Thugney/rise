...
if (!function_exists('get_ai_setting')) {
    ...
    function get_ai_setting($name) {
        ...
        $value = $Ai_settings_model->get_setting($name);
        $cache[$name] = $value;
...
if (!function_exists('has_ai_subscription')) {
    ...
    function has_ai_subscription($user_id) {
        ...
        return $polar->has_active_subscription($user_id);
    }
}

/**
 * Get AI subscription checkout URL for a user
 *
 * @param int $user_id User ID
 * @param string $email User email
 * @return string|null Checkout URL
 */
...
/**
 * Check if user can access AI assistant (enabled + subscription)
 *
 * @param int $user_id User ID
 * @return array Status array with 'allowed' and 'reason'
 */
if (!function_exists('can_access_ai')) {

    function can_access_ai($user_id) {
        if (!is_ai_enabled()) {
            return array(
                'allowed' => false,
                'reason' => 'ai_disabled',
